...
def run_pretrain():
    ...
    ds = create_bert_dataset(device_num, rank, cfg.rbd_name, cfg.do_shuffle, cfg.data_dir, cfg.schema_dir,
                             cfg.batch_size,
                             cfg.bucket_list)
    ...
    if cfg.enable_save_ckpt == "true" and cfg.device_id % min(8, device_num) == 0:
        ...
        ckpoint_cb = ModelCheckpoint(prefix='checkpoint_%s' % cfg.rbd_name,
